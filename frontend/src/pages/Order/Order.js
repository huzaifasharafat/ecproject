...
import PayButton from '../payOptions/PayButton.jsx'
...
const Order = ({match,history}) => {
    ...
    return loading || loadingDeliver ? <div className='loading-product'>
                        <HashLoader   c olor={"#1e1e2c"}  loading={loading || loadingDeliver} size={50} />
                ...
                <div className="your-products">
                        ...
                        {!order.isPaid && (
                            ...
                            {/* {!sdkReady ? <div className='loading-product'>
                                           ...
                                           <div className = 'paypalbuttons'>
                                            <PayButton  className = 'buttonsp' order={order}  orderId = {orderId} />
                                           </div>
                                           {/* <div >
                                            <CheckoutSuccess orderId = {order._id}  />
                                           </div> */}
