            ...
            <div className="limit-check">
                ...
                <div className="info-check">
                    ...
                    <div className="payment-check">
                        ...
                        <input onChange = {(e)=> {setcarddetails(true) ; setPayment('card')}} checked = {carddetails}  type="radio" name="payment" id="card"/><label for="card" className="this-label">Debit Card</label>
                        ...
                        <Input variant="flushed" id="name-card" placeholder="Muhammad Taha"/></div>
